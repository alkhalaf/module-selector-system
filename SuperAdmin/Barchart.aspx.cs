...
public partial class SuperAdmin_Barchart : System.Web.UI.Page
{
 ...
 private void chart_bind()
    ...
    public void Bindregistrationno()
    {

        try
        {
            ddlregno.DataSource = Module.Bindregno();
            ddlregno.DataTextField = "StudentRegno";
            //ddlregno.DataValueField = "Id";
            ddlregno.DataBind();
            ddlregno.Items.Insert(0, new ListItem("----Select----", "0"));
