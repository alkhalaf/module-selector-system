<%@ Page Language="C#" MasterPageFile="~/Student/Student.master" AutoEventWireup="true" CodeFile="Gradeprediction.aspx.cs" Inherits="Student_Gradeprediction" Title="Untitled Page" %>
 ...
 <asp:Panel ID="Panel1" runat="server" ScrollBars="Horizontal" Width="820px">
     <table width="100%" cellpadding="0px" cellspacing="0px" style="border: thin double #000000; background-color:ActiveBorder">
         <tr>
             <td align="center" colspan="12" bgcolor="LavenderBlush">
                 <asp:Label ID="Label111" runat="server" Font-Bold="True" Font-Size="Medium" 
                     Font-Underline="True" ForeColor="#FF3300" Text="At Level-4"></asp:Label>
             </td>
         </tr>
         <tr>
         ...
         <tr >
             ...
             <td class="tdbodertop">
                 <asp:Label ID="ass7mod1" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass8mod1" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass9mod1" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass10mod1" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
         ...
         <tr bgcolor="LavenderBlush">
             ...
             <td class="tdbodertop">
                 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                     <ContentTemplate>
                         <asp:TextBox ID="txtass1mod1" runat="server" Width="40px" 
                             ontextchanged="txtass1mod1_TextChanged" AutoPostBack="True" onkeyup="checklimit(this.id)"></asp:TextBox>
                     </ContentTemplate>
                 </asp:UpdatePanel>
             </td>
             <td class="tdbodertop">
