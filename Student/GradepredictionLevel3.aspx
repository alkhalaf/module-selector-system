<%@ Page Language="C#" MasterPageFile="~/Student/Student.master" AutoEventWireup="true" CodeFile="GradepredictionLevel3.aspx.cs" Inherits="Student_Gradeprediction" Title="Untitled Page" %>
 ...
 <asp:Panel ID="Panel1" runat="server" ScrollBars="Horizontal" Width="820px">   
     <table width="100%" cellpadding="0px" cellspacing="0px" style="border: thin double #000000; background-color:ActiveBorder">
         <tr>
             <td align="center" colspan="12" bgcolor="LavenderBlush">
                 <asp:Label ID="Label111" runat="server" Font-Bold="True" Font-Size="Medium" 
                     Font-Underline="True" ForeColor="#FF3300" Text="At Level-6"></asp:Label>
             </td>
         </tr>
         <tr>
         ...
         <tr>
             ...
             <td class="tdbodertop">
                 <asp:Label ID="ass8mod2" runat="server" ForeColor="#85582C" Font-Size="X-Small"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass9mod2" runat="server" ForeColor="#85582C" Font-Size="X-Small"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass10mod2" runat="server" ForeColor="#85582C" 
                     Font-Size="X-Small"></asp:Label>
             </td>
             <td class="tdbodertop">
         ...
         <tr>
             ...
             <td class="tdbodertop">
                 <asp:Label ID="ass1mod3" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass2mod3" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass3mod3" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass4mod3" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass5mod3" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass6mod3" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass7mod3" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass8mod3" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass9mod3" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass10mod3" runat="server" CssClass="#85582C" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
         ...
         <tr>
             ...
             <td class="tdbodertop">
                 <asp:Label ID="ass1mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass2mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass3mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass4mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass5mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass6mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass7mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass8mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass9mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass10mod4" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
         ...
         <tr>
             ...
             <td class="tdbodertop"> 
                 <asp:Label ID="ass1mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass2mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass3mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass4mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass5mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass6mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass7mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass8mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass9mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass10mod5" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
         ...
         <tr>
             ...
             <td class="tdbodertop">
                 <asp:Label ID="ass1mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass2mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass3mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass4mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass5mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass6mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass7mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass8mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass9mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass10mod6" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
         ...
         <tr>
             ...
             <td class="tdbodertop">
                 <asp:Label ID="ass1mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass2mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass3mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td>
                 <asp:Label ID="ass4mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass5mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass6mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass7mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass8mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass9mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass10mod7" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
         ...
         <tr>
             ...
             <td>
                 <asp:Label ID="ass1mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass2mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass3mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass4mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass5mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass6mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass7mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td>
                 <asp:Label ID="ass8mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass9mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
                 <asp:Label ID="ass10mod8" runat="server" ForeColor="#85582C"></asp:Label>
             </td>
             <td class="tdbodertop">
