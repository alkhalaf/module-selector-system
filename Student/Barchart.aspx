<%@ Page Language="C#" MasterPageFile="~/Student/Student.master" AutoEventWireup="true" CodeFile="Barchart.aspx.cs" Inherits="SuperAdmin_Barchart" Title="Untitled Page" %>
   ...
   <div class="cmnClssRightTop1">Bar-Chart</div>
    ...
    <tr class ="tbcolor2">
        <td>
            Your Enroll.No</td>
        <td>
            <asp:TextBox ID="txtenroll" runat="server" ReadOnly="True" Width="150px"></asp:TextBox>
        </td>
        <td>
            Choose Order</td>
        <td>
                ...
                onselectedindexchanged="DropDownList4_SelectedIndexChanged">
                    <asp:ListItem Value="0">-Select-</asp:ListItem>
                    <asp:ListItem Value="1">Alphabatical Order</asp:ListItem>
